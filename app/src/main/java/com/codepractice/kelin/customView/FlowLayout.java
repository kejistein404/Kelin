...
import com.codepractice.kelin.R;
...
public class FlowLayout extends ViewGroup {
    ...
    public FlowLayout(Context context, AttributeSet attrs) {
        ...
        mVerticalSpacing = typedArray.getFloat(R.styleable.FlowLayout_verticalSpacing, 10);
        mHorizontalSpacing = typedArray.getFloat(R.styleable.FlowLayout_horizontalSpacing, 10);
        typedArray.recycle();
    }
